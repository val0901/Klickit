...
-->
            ...
            <div class="col-md-5 viewart_fontweight"><!---->
                ...
                <span class="viewart_fontsolde salesItems">
                    ...
                    <?=str_replace('.', ',', $items['price']);?> €
                    <?php elseif($items['newPrice'] > 0): ?>
                    <?=str_replace('.', ',', $items['newPrice']);?> €
                    <?php endif; ?>
                </span>
                ...
                <?php elseif($items['quantity'] > 0): ?>
                    ...
                    <div class="ajoutpanier item"><!---->
                        ...
                        <?php else : ?>
                        <a href="<?=$this->url('login');?>" target="_blank"><button data-id="<?=$items['id']?>" type="button" class="btn btn-primary viewcategory_button_size">  <span class="name">
                            Ajouter au panier
                            </span>
                            </button></a>
                        <?php endif; ?>
