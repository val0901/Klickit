...
<div class="apropos_container">
    ...
    <p class="apropos_text">Désormais, nous vous proposons tous ces produits en ligne !</p>
    ...
    <br><br>
    <!-- paypal CB -->
    <div class="apropos_containpaie">
        <div class="apropos_picsortpaie">
            <div class="apropos_td"><img src="<?=$this->assetUrl('img/logo_paypal_moyens_paiement_fr.png');?>" class="fa fa-cc-paypal fa-4x apropos_sortpaie" aria-hidden="true"></div>
            <div class="apropos_td">CB</div>
        </div>

    <!-- paypal -->
        <div class="apropos_picsortpaie">
            <div class="apropos_td"><img src="<?=$this->assetUrl('img/paypal_logo2.jpg');?>" class="fa fa-cc-paypal fa-4x apropos_sortpaie" aria-hidden="true"></div>
            <div class="apropos_td">Paypal</div>
        </div>

    <!-- cheque -->
        <div class="apropos_picsortpaie">
            <div class="apropos_td"><img src="<?=$this->assetUrl('img/paiement_cheque.jpg');?>" class="fa fa-cc-paypal fa-4x apropos_sortpaie" aria-hidden="true"></div>
            <div class="apropos_td">Chèque</div>
        </div>

    <!-- virement -->
        <div class="apropos_picsortpaie">
            <div class="apropos_td"><img src="<?=$this->assetUrl('img/paiement_virement.jpg');?>" class="fa fa-cc-paypal fa-4x apropos_sortpaie" aria-hidden="true"></div>
            <div class="apropos_td">Virement</div>
        </div>
